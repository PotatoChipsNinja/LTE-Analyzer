...
# tbC2I
csv_data = pd.read_csv('data/tbC2I.csv', encoding='utf-8', usecols=['SCELL','NCELL','C2I_Mean' ])
...
# tbCell
csv_data = pd.read_csv('data/tbCell.csv', encoding='utf-8', usecols=['SECTOR_ID','LONGITUDE','LATITUDE' ])
coordinate_dict = {}
for index,row in csv_data.iterrows():
